...
predictor = dlib.shape_predictor("D:\SQL\Drowsiness_Detection-master/models/shape_predictor_68_face_landmarks.dat")
...
while(True):
    ...
    for rect in rects:
        ...
        if p2[1] > p1[1]*1.5 or COUNTER_BLINK > 8  or COUNTER_MOUTH > 2:
